 ...
 */
let socialMediaFriends = 450
print(socialMediaFriends)
 ...
 */
var friendsBeforeDelete = socialMediaFriends
var friendsAfterDelete = socialMediaFriends - 100
print(friendsAfterDelete)
 ...
 */
let explanation = "The method I used compiled correctly and shows 350 instead of 450 for the number of friends."
print(explanation)
