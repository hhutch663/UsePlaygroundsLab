...
switch currentHR {
case Int.min...120:
    print("You're in the Very Light zone.  Activity in this zone helps with recovery.")
case 121...130:
    print("You're in the Light zøne.  Activity in this zone helps improve basic endurance and fat burning.")
case 141...160:
    print("You're in the Moderate zone.  Activity in this zone helps improve aerobic fitness.")
case 161...180:
    print("You're in the Hard zone.  Activity in this zone increases maximum performance capacity for shorter sessions.")
case 181...200:
    print("You're in the Maximum zone.  Activity in this zone helps fit athletes develop speed.")
default:
