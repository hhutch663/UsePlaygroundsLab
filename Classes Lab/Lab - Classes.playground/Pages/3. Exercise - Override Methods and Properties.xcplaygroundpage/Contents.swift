...
let shieldedShip = ShieldedShip()

shieldedShip.name = "Defender"
shieldedShip.name

shieldedShip.weapon = "Cannon"
shieldedShip.weapon

shieldedShip.moveRight()
shieldedShip.position

shieldedShip.fire()
shieldedShip.remainingFirePower
 ...
 */
shieldedShip.wasHit()
print(shieldedShip.shieldStrength)
print(shieldedShip.health)
